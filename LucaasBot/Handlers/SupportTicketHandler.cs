...
{
    public class SupportTicketHandler : DiscordHandler
    {
        ...
        public static IMongoCollection<ulong> BlockedUsers
            => MongoService.BlockedTicketUsers;

        public static IMongoCollection<TicketSnippet> Snippets
            => MongoService.Snippets;
