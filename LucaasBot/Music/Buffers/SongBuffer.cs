...
namespace LucaasBot.Music.Buffers
{
    public sealed class SongBuffer : IDisposable
    {
        ...
        public SongBuffer(string songUri, bool isLocal)
        {
            ...
            {
                Logger.Write(@"You have not properly installed or configured FFMPEG. 
Please install and configure FFMPEG to play music. 
Check the guides for your platform on how to setup ffmpeg correctly:
    Windows Guide: https://goo.gl/OjKk8F
    Linux Guide:  https://goo.gl/ShjCUo", Severity.Music, Severity.Critical);
            }
        ...
        public void Dispose()
        {
            ...
            {
                Logger.Write(ex, Severity.Music, Severity.Error);
            }
            try
            {
