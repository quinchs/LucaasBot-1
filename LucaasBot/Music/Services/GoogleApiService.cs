...
namespace LucaasBot.Music.Services
{
    public class GoogleApiService
    {
        ...
        public GoogleApiService(IHttpClientFactory factory)
        {
            ...
            var bcs = new BaseClientService.Initializer
            {
                ...
                ApiKey = ConfigService.Config.GoogleApiKey,
            };
        ...
        public async Task<string> ShortenUrl(string url)
        {
            ...
            if (string.IsNullOrWhiteSpace(ConfigService.Config.GoogleApiKey))
                return url;
